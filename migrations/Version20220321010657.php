 ...
 */
final class Version20220321010657 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE table_info (id INT AUTO_INCREMENT NOT NULL, data_base_id INT DEFAULT NULL, label VARCHAR(50) NOT NULL, name VARCHAR(50) NOT NULL, description VARCHAR(255) DEFAULT NULL, is_active TINYINT(1) DEFAULT \'1\' NOT NULL, INDEX IDX_815F719CD6C89B0 (data_base_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE table_info ADD CONSTRAINT FK_815F719CD6C89B0 FOREIGN KEY (data_base_id) REFERENCES data_base_info (id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE table_info DROP FOREIGN KEY FK_815F719CD6C89B0');
